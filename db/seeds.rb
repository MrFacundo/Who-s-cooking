...
meal7 = Meal.create(name: "Vegan chocolate mousse", difficulty: 2, prep_time: 40, price: 10, description: "Tasty chocolate mousse with only vegan ingredients. Perfect dessert for a summer day.", restaurant: Restaurant.first, chef: Chef.first, menu_type: "Dessert", video: 'https://player.vimeo.com/video/372327996')
